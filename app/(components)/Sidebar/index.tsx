...
const Sidebar = () => {
  ...
  const sidebarClassNames =
    'fixed flex h-full flex-col justify-between shadow-xl transition-all duration-300 z-40 overflow-y-auto bg-white w-64'
    ...
    <div className={sidebarClassNames}>
      <div className="flex h-full w-full flex-col justify-start">
        ...
        <div className="flex items-center gap-5 border-y-[1.5px] border-gray-200 px-8 py-4 dark:border-gray-700">
          ...
          <div>
            <h3 className="text-base font-bold tracking-wide dark:text-gray-200">Cricket Team 1</h3>
